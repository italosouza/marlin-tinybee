...
#define STRING_CONFIG_H_AUTHOR "Guilhotina" // Who made the changes.
...
#define MACHINE_UUID "72950a4f-6a47-48d0-96ab-6736b7367a4d"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1693, 93 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -9, -1.8 }
...
#define X_BED_LEFT 70
#define Y_BED_FRONT 45
// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -3
#define Y_MIN_POS -3
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + X_BED_LEFT
#define Y_MAX_POS Y_BED_SIZE + Y_BED_FRONT
